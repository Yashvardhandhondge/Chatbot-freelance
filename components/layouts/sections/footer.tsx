...
export default function Footer() {
  return (
    <div className="w-screen md:h-[70vh] mt-10 md:mt-20 h-full flex flex-col justify-center px-6 py-12 sm:px-10">
      <footer className="bg-[#29262592] text-gray-400 py-8 rounded-2xl">
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between gap-8 sm:gap-16">
          ...
          <div className="mb-8 text-center md:text-left">
            ...
            >
              ...
              <h2 className="text-white">ValorAI</h2>
            </Link>
          </div>
          ...
          <div className="grid grid-cols-2 px-10 sm:grid-cols-4 gap-8 sm:gap-16 mb-12">
            <div>
              ...
              <div className="space-y-3">
                <Link href="https://github.com" className="block hover:text-white transition-colors">
                  Github
                </Link>
                <Link href="https://twitter.com" className="block hover:text-white transition-colors">
                  Twitter
                </Link>
                <Link href="https://instagram.com" className="block hover:text-white transition-colors">
                  Instagram
                </Link>
              </div>
            </div>
            ...
            <div>
              ...
              <div className="space-y-3">
                <Link href="/ios" className="block hover:text-white transition-colors">
                  iOS
                </Link>
                <Link href="/android" className="block hover:text-white transition-colors">
                  Android
                </Link>
                <Link href="/web" className="block hover:text-white transition-colors">
                  Web
                </Link>
              </div>
            </div>
            ...
            <div>
              ...
              <div className="space-y-3">
                ...
                <Link href="/feedback" className="block hover:text-white transition-colors">
                  Feedback
                </Link>
              </div>
            </div>
            ...
            <div>
              ...
              <div className="space-y-3">
                <Link href="https://twitch.tv" className="block hover:text-white transition-colors">
                  Twitch
                </Link>
                <Link href="https://discord.com" className="block hover:text-white transition-colors">
                  Discord
                </Link>
                <Link href="https://dribbble.com" className="block hover:text-white transition-colors">
                  Dribbble
                </Link>
              </div>
            </div>
        ...
        <div className="text-sm border-t border-gray-800 pt-8 text-start px-4 sm:px-10">
