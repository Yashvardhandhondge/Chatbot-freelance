...
export default function Testimonials() {
  return (
    <div id='testimonials' className="py-16 px-10 bg-black flex flex-col items-center justify-center ">
      <div className="container px-4 md:px-6">
        <div className="text-center mb-12">
          <h2 className="text-orange-500 mb-2">Testimonials</h2>
          <h3 className="sm:text-4xl text-2xl font-bold text-white">Hear From Our Veterans</h3>
        </div>
          ...
          <CarouselContent>
            {testimonials.map((testimonial, index) => (
              <CarouselItem key={index} className="md:basis-1/2 lg:basis-1/3">
                <Card className="bg-zinc-900 border-zinc-800 m-2">
